...
#include "butlerVolmerFixedPotentialFvPatchVectorField.H"
...
butlerVolmerFixedPotentialFvPatchVectorField
(
    const butlerVolmerFixedPotentialFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
butlerVolmerFixedPotentialFvPatchVectorField
(
    const butlerVolmerFixedPotentialFvPatchVectorField& bvcpvf
)
:
...
void Foam::butlerVolmerFixedPotentialFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    scalar maxCurrent = 
        electrodeDict.lookupOrDefault<label>("maxCurrentDensity", 10000.0);
...
void Foam::butlerVolmerFixedPotentialFvPatchVectorField::write(Ostream& os) const
{
...
void Foam::butlerVolmerFixedPotentialFvPatchVectorField::operator=
(
