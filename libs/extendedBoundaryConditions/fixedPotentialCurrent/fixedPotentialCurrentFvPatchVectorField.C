...
#include "fixedPotentialCurrentFvPatchVectorField.H"
...
fixedPotentialCurrentFvPatchVectorField
(
    const fixedPotentialCurrentFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
fixedPotentialCurrentFvPatchVectorField
(
    const fixedPotentialCurrentFvPatchVectorField& bvcpvf
)
:
...
void Foam::fixedPotentialCurrentFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
//    const Field<scalar>& magS = patch().magSf();
    ...
    {
        FatalErrorIn("fixedPotentialCurrentFvPatchVectorField::updateCoeffs()")
...
void Foam::fixedPotentialCurrentFvPatchVectorField::write(Ostream& os) const
{
...
void Foam::fixedPotentialCurrentFvPatchVectorField::operator=
(
