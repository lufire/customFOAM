...
Foam::liquidFick<ThermoType>::liquidFick
(
...
template<class ThermoType>
void Foam::liquidFick<ThermoType>::updateCoefficients()
{     
    DijModel_().update();
...
template<class ThermoType>
Foam::scalar Foam::liquidFick<ThermoType>::correct
(
...
template<class ThermoType>
bool Foam::liquidFick<ThermoType>::read()
{
    if (regIOobject::read())
    {
        return true;
