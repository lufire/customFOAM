...
Foam::liquidFickDilutedMixture<ThermoType>::liquidFickDilutedMixture
(
    // A.Alexiou 2014
...
template<class ThermoType>
void Foam::liquidFickDilutedMixture<ThermoType>::updateCoefficients()
{
