...
#include "makeElectrolyteModel.H"
...
makeElectrolyteModel(concentratedElectrolyte, constEThermoPhysics);
makeElectrolyteModel(concentratedElectrolyte, constHThermoPhysics);
