...
defineTypeNameAndDebug(Coussot, 0);
addToRunTimeSelectionTable(rheologyModel, Coussot, dictionary);
...
:
    ...
    n_(this->subDict((this->type()+"Coeffs")).lookup("n"))
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Coussot::correct()
{
