...
#include "extendedChemistryModel.H"
...
Foam::extendedChemistryModel<CompType, ThermoType>::extendedChemistryModel
(
    const fvMesh& mesh
)
:
    ...
    reactions_
    (
        dynamic_cast<const concReactingMixture<ThermoType>&>(this->thermo().composition())
    ),
    specieThermo_
    (
        dynamic_cast<const concReactingMixture<ThermoType>&>
    ...
    RR_(nSpecie_)
{
    ...
    Info<< "extendedChemistryModel: Number of species = " << nSpecie_
...
Foam::extendedChemistryModel<CompType, ThermoType>::omega
(
    const scalarField& c,
    const scalar T,
    const scalar p
...
template<class CompType, class ThermoType>
Foam::scalar Foam::extendedChemistryModel<CompType, ThermoType>::omegaI
(
    const label index,
    const scalarField& c,
    const scalar T,
...
template<class CompType, class ThermoType>
Foam::scalar Foam::extendedChemistryModel<CompType, ThermoType>::omega
(
...
template<class CompType, class ThermoType>
void Foam::extendedChemistryModel<CompType, ThermoType>::derivatives
(
    const scalar time,
    const scalarField &c,
    scalarField& dcdt
...
template<class CompType, class ThermoType>
void Foam::extendedChemistryModel<CompType, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    scalarField& dcdt,
...
Foam::extendedChemistryModel<CompType, ThermoType>::tc() const
{
    scalar pf, cf, pr, cr;
    label lRef, rRef;
...
template<class CompType, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::extendedChemistryModel<CompType, ThermoType>::Sh() const
{
...
template<class CompType, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::extendedChemistryModel<CompType, ThermoType>::dQ() const
{
...
template<class CompType, class ThermoType>
Foam::label Foam::extendedChemistryModel<CompType, ThermoType>::nEqns() const
{
...
template<class CompType, class ThermoType>
void Foam::extendedChemistryModel<CompType, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::extendedChemistryModel<CompType, ThermoType>::solve
(
...
template<class CompType, class ThermoType>
void Foam::extendedChemistryModel<CompType, ThermoType>::solve
(
    scalarField &c,
    scalar& T,
    scalar& p,
